...
if __name__ == '__main__':
    ...
    #l=[[0, 0, 23],[2, 0, 23],[2, 2, 23],[2, 2, 25],[-5, 2, 25],[-5, -3, 25],[-5, -3, 21],[7, -3, 21],[7, 0, 21],[0, 0, 19]]
    ...
    while not rospy.is_shutdown():
        if math.fabs(swift_drone.error[0])<=0.2 and  math.fabs(swift_drone.error[1])<=0.2 and  math.fabs(swift_drone.error[2])<=0.2 and i<len(l):
            ...
            i+=1
            if (i==len(l)-1) and  math.fabs(swift_drone.error[0])<=0.2 and  math.fabs(swift_drone.error[1])<=0.2 and  math.fabs(swift_drone.error[2])<=0.2 :
                swift_drone.disarm()
                break
        swift_drone.pid()
        r.sleep()
