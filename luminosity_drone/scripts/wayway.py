...
class Swift():
    ...
    def pid(self):
        ...
        self.cmd.rcThrottle = 1540 + (p[2] + i[2] + d[2])
...
if __name__ == '__main__':
    ...
    while not rospy.is_shutdown():
        if on_centroid:
            swift_drone.Kpid = 1.0
            swift_drone.error[2] = swift_drone.drone_position[2] - target[2]
            if math.fabs(swift_drone.error[2]) < 1:
                swift_drone.error[0] = swift_drone.drone_position[0] - target[0]
                swift_drone.error[1] = swift_drone.drone_position[1] - target[1]
                if   (math.fabs(swift_drone.error[0]) < 0.5
